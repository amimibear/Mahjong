...
class Pubilc_MahJong(MahJong_NO_State_Base):
    ...
    def __init__(self, mess_data):
        ...
        fin = open("C:\\Users\\1\Desktop\\ai-demo\\src\\in.txt","w")
        print(mess_data.decode())
        #fin.write(mess_data)
        fin.write(mess_data.decode())
        fin.close()

        os.system("C:\\Users\\1\\Desktop\\ai-demo\\src\\ijcai_.exe")

        fout = open("C:\\Users\\1\Desktop\\ai-demo\\src\\out.txt","r")
        mess=fout.read()
        fout.close()
        #print(type(mess))
        #print(mess)

        self.ReqMess=eval(mess)
...
if __name__ == "__main__":
    ...
    test_str = {"pon_hand":"","kon_hand":"","chow_hand":"","hand":"C2C6D7C8B3C4D1D4C2D2C2C3B2C4","history":["3,Discard,D1","0,Discard,B5"],"dealer":3,"seat":0,"special":""}
